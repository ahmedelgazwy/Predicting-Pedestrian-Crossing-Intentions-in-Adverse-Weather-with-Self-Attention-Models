...
path_jaad = "./Ahmed_Elgazwy/Pedestrian_Crossing_Intention_Prediction-main/JAAD"
...
def run(config_file=None):
    ...
    configs_default ='./Ahmed_Elgazwy/Pedestrian_Crossing_Intention_Prediction-main/config_files/configs_default.yaml'
