   ...
   # @profile
    def test(self, data_test, model_path=''):
        ...
        for i in range (len(test_results)):
            if np.round(test_results[i][0])==1 and test_data['data'][1][i][0]==1:
             key=i
             break

        #return key, test_data['data'][1][key]
        return np.round(test_results[55:66]), test_data['data'][1][55:66]
